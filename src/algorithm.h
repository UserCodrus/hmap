...
public:
	...
	const T* nearest(const T& location) const;
...
private:
	...
	// Find the nearest point on a given branch of the tree
	KDNode2D<T>* nearestNode(const T& location, KDNode2D<T>* root, float& nearest_distance, bool xaxis);
